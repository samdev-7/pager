<script lang="ts">
	...
	let authFailedMessage = $state('Unknown error.');
...
<div class="flex min-h-screen flex-col items-center justify-center">
	<div class="flex flex-grow items-center justify-center p-12">
		{#if !emailProcessing}
			<Card.Root class="flex min-w-96 grow flex-col">
				<Card.Header>
				...
				<Card.Content class="flex flex-col space-y-6">
					{#if !emailSent}
						...
						<div class="flex flex-col space-y-2">
							<Button on:click={googleAuth} variant="outline">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="-mb-0.5 mr-2 size-5"
									viewBox="0 0 16 16"
							...
							<Button on:click={githubAuth} variant="outline">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="-mb-0.5 mr-2 size-5"
									viewBox="0 0 64 64"
					...
					{#if authFailed}
						<Alert.Root variant="destructive">
							...
							<Alert.Description>
								{authFailedMessage || 'Unknown error.'}
							</Alert.Description>
						</Alert.Root>
					{/if}
				</Card.Content>
